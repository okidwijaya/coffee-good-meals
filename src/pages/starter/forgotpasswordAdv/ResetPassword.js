...
<div className="password">
  <label for="password-input" className="password-label">Old Password</label>
  <input type="password" id="password-input"/>
</div>

<div className="new-password">
  <label for="new-password-input" className="new-password-label">New Password</label>
  <input type="password" id="new-password-input"/>
</div>

<div className="password-verification">
  <label for="password-input" className="password--verification-label">Password Verification</label>
...
<div className="back-login">
  <div className="back">
    <a href="#"><i className="fa fa-angle-double-left"></i> Back to Login</a>
  </div>
  <div className="reset-password-button" onclick="airTableResetPassword()">
